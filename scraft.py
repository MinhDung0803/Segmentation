...
def get_all_task():
    list_task = []
    for directories in os.listdir('/home/gg-greenlab/Downloads/test/data'):
...
def rename_images_and_annotation(task_num_in):
    images_path = "/home/gg-greenlab/Downloads/test/data/" + str(task_num_in) + "/default/"
    images_path_output = "/home/gg-greenlab/Downloads/test/data/" + str(task_num_in) + "/default_output/"
    ...
    annotations_path = "/home/gg-greenlab/Downloads/test/data/" + str(task_num_in) + "/defaultannot/"
    annotations_path_output = "/home/gg-greenlab/Downloads/test/data/" + str(task_num_in) + "/defaultannot_output/"
...
def convert_label_using_numpy_array(task_num_in):
    ...
    path = "/home/gg-greenlab/Downloads/test/data/" + str(task_num_in) + "/defaultannot_output/"
    path_save = "/home/gg-greenlab/Downloads/test/data/" + str(task_num_in) + "/result/"
...
def copytree_annotations(task_num_input, symlinks=False, ignore=None):
    ...
    src = "/home/gg-greenlab/Downloads/test/data//" + str(task_num_input) + "/result/"
    # main data location
    dst = "/storages/data/dungpm/All_data/backup/test/LV-MHP-v1/annotations/"
    # # for test
...
def copytree_images(task_num_input_im, symlinks=False, ignore=None):
    ...
    src = "/home/gg-greenlab/Downloads/test/data//" + str(task_num_input_im) + "/default_output/"
    # main data location
    dst = "/storages/data/dungpm/All_data/backup/test/LV-MHP-v1/images/"
    # # for test
...
def split_train_test_data(test_size_value):
    list_images = []
    # main data location
    data_path = "/storages/data/dungpm/All_data/backup/test/LV-MHP-v1/images/"
    # # for test
    ...
    # for train_list file
    # main data location
    textfile_train = open("/storages/data/dungpm/All_data/backup/test/LV-MHP-v1/train_list.txt", "w")
    # # for test
    ...
    # for test_list file
    # main data location
    textfile_test = open("/storages/data/dungpm/All_data/backup/test/LV-MHP-v1/test_list.txt", "w")
    # # for test
